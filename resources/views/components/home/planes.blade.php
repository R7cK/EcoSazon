<section class="py-5">
    <div class="container">
        ...
        <div class="row justify-content-center g-4 align-items-stretch">
          {{-- ESTILO DEL BOTÓN VERDE INTEGRADO AQUÍ MISMO --}}
<style>
    .btn-green-solid {
        background-color: #198754; /* Verde clásico */
        color: white !important;
        border: none;
        transition: all 0.3s ease;
    }
    .btn-green-solid:hover {
        background-color: #146c43; /* Verde ligeramente más oscuro al hacer hover */
        color: white !important;
        transform: translateY(-3px); /* El brinquito hacia arriba */
        box-shadow: 0 10px 20px rgba(25, 135, 84, 0.4) !important; /* Sombra verde */
    }
</style>
...
<div class="col-md-5">
    <div class="card h-100 shadow-sm text-center p-4" style="border-radius: 25px; background-color: #Eafaf1; border: 3px solid var(--verde) !important;">
        <div class="card-body d-flex flex-column">
            ...
            {{-- BOTÓN VERDE ACTUALIZADO: Le agregamos btn-green-solid y btn-lg --}}
            <a href="{{ route('register') }}" class="btn btn-green-solid btn-lg w-100 rounded-pill shadow fw-bold mt-auto">Registrarse Gratis</a>
        </div>
    </div>
</div>
