...
@section('titulopagina', 'Planes de Suscripción - EcoSazón')
@section('titulo', 'Elige el plan ideal para ti')
@section('subtitulo', 'Ahorra en envíos y apoya al comercio local con EcoSazón Plus.')
